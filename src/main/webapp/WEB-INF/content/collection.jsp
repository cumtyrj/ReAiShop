				...
				<div class="col-md-8">
					<div class="row">
						...
						<table border="1"   class ="text-center">
							...
							<c:forEach items="${requestScope.collect_list}" var="good">
								<tr>
								<td width="100px">${good.name }</td>
								<td>${good.price }</td>
								<td width="120px">${good.detail }</td>
								<td><img src="source/img/${good.image}" height="60"></td>
								<td>
								<a class="btn btn-warning" href="removecollect?good_id=${good.good_id}" role="button">X</a>                      							
                        		<br/><br/>
								<input type="hidden" value="${good.good_id}">
								<a class="btn btn-danger" href="lookupgood?good_id=${good.good_id}" role="button">查看详情</a></td>
								</tr>
							</c:forEach>
							</table>
							<br/><br/><br/>
							<a class="btn btn-danger" href="clearcollect?good_id=${good.good_id}" role="button">清空收藏夹</a>                      	
