				...
				<div class="col-md-8">
					<div class="row">
						...
						<table border="1" id="table">
							...
							<c:forEach items="${requestScope.chair_list }" var="chair">
								<tr>
								<td>${chair.name }</td>
								<td>￥${chair.price }</td>
								<td>${chair.detail }</td>
								<td><img src="source/img/${chair.image1}" height="60"></td>
								<td><a class="btn btn-danger" href="lookupgood?good_id=${chair.good_id}" role="button">查看详情</a></td>
								</tr>
							</c:forEach>
							</table>
						</div>
