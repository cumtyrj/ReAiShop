...
<script type="text/javascript" src="source/js/jquery3.js">
				...
				<div class="col-md-8">
					<div class="row">
						...
						<table border="1">
							...
							<c:forEach items="${requestScope.vessel_list }" var="vessel">
								<tr>
								<td>${vessel.name }</td>
								<td>￥${vessel.price }</td>
								<td>${vessel.detail }</td>
								<td><img src="source/img/${vessel.image1}" height="60"></td>
								<td><a class="btn btn-danger" href="lookupgood?good_id=${vessel.good_id}" role="button">查看详情</a></td>			
								</tr>
							</c:forEach>
							</table>
						</div>
